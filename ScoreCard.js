 ...
 let finalSum = 0;
    function conversion(){
      var b = document.getElementsByClassName("cell");
      var i = 0;
      while(i < b.length){
        let x = document.getElementsByClassName("cell")[i].value;
        if(x.includes("1/8")){
          document.getElementById(b[i]).value = 0.125;
        }
      }
      
      /*
      var b = document.getElementById("mainBeamLeft").value;
      if(b.includes("1/8")){
        document.getElementById("mainBeamLeft").value = 0.125;
      }*/
    }
